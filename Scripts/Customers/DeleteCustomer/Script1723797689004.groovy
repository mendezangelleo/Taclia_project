...
WebUI.click(findTestObject('Object Repository/Customers/EditCustomer/button_Eliminar_1'))
WebUI.click(findTestObject('Object Repository/Customers/EditCustomer/button_S, eliminar'))
