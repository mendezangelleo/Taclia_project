...
try {
	...
	RegistrationPage.fillForm(generatedEmail)

	// Clicar en el botón de siguiente paso (aquí es donde se activaría el reCAPTCHA)
	RegistrationPage.clickNextStep()

	// Obtener y manejar el token de reCAPTCHA
	RegistrationPage.getReCaptchaToken()

	WebUI.comment('Formulario de registro completado, reCAPTCHA manejado y siguiente paso clicado.')
